...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config.js":"2hPh4"}],"dfIpa":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _views = require("./Views");
var _viewsDefault = parcelHelpers.interopDefault(_views);
const icons = new URL(require("a0b82650a605f976")).href;
const Fraction = require("9c16d2c8cc0782c8");
...
exports.default = new RecipeView(); // Exportar solo una instancia de la clase RecipeView, no la clase completa. Esto permite que se use directamente sin necesidad de crear una nueva instancia cada vez que se importe.

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","a0b82650a605f976":"aob6l","9c16d2c8cc0782c8":"md6n5","./Views":"agRZU"}],"aob6l":[function(require,module,exports,__globalThis) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const icons = new URL(require("8b4c6469f0de3914")).href;
class View {
    _data;
    render(data) {
    ...
    renderError(message = this._errorMessage) {
        const _errorMessage = 'We could not find that recipe. Please try another one!';
        const markup = `
        <div class="error">
            <div>
              <svg>
    ...
    renderMessage(message = this._message) {
        const _message = 'Find your recipe!';
        const markup = `
        <div class="message">
            <div>
              <svg>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","8b4c6469f0de3914":"aob6l"}],"02c4V":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
